...
impl Blog {
    ...
    pub fn new_article(&self, body: String) -> (usize, Article<'_>) { // Fixed lifetime annotation
        let id = self.new_id();
...
impl<'a> Article<'a> {
    pub fn new(id: usize, body: String, blog: &'a Blog) -> Article<'a> { // Fixed return type
        Article { id, body, parent: blog }
    }
